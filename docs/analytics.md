...
| `pricing_faq_opened` | client (`PricingFaq.tsx`) | `question` (the FAQ heading text), `pricing_variant`. Once per question per page load — which objection people look for |
