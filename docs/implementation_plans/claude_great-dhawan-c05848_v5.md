# Full Drive / folder support — research plan v5

Branch: `claude/great-dhawan-c05848` · Date: 2026-09-18 · Status: research, no code change · Supersedes v4 (the full-`drive` spike completed: §1.5 and §1.6 are now measured, not documented)
