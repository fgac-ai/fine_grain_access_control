# Full Drive / folder support — research plan v2

Branch: `claude/great-dhawan-c05848` · Date: 2026-09-17 · Status: research, no code change · Supersedes v1 (adds the measured folder-pick result and closes Design B)
