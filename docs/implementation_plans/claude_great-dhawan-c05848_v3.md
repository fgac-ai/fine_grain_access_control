# Full Drive / folder support — research plan v3

Branch: `claude/great-dhawan-c05848` · Date: 2026-09-17 · Status: research, no code change · Supersedes v2 (adds the attempted full-`drive` edit spike, §1.6)
